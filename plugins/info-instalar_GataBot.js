...
apt update -y && yes | apt upgrade && pkg install -y bash wget mpv && wget -O - https://raw.githubusercontent.com/The-DiosBot-MD/The-MikuBot-MDV5/master/gata.sh | bash
*━━━━━━━━━━━━━⬣*
𝙄𝙉𝙎𝙏𝘼𝙇𝘼𝙍 𝙀𝙉 𝙃𝙀𝙍𝙊𝙆𝙐
*⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯*
*_https://heroku.com/deploy?template=https://github.com/The-DiosBot-MD/The-MikuBot-MDV5_*
*⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯*
...
conn.sendButton(m.chat, gata, `Comunícate con el soporte si necesitas ayuda con la Instalación.\n\n${ig}\n${wm}`, picture, [
['𝐂𝐮𝐞𝐧𝐭𝐚𝐬 𝐎𝐅𝐂', '.cuentasgb'],
['𝐃𝐨𝐧𝐚𝐫', '.donar']], 'termux-setup-storage\n\napt update -y && yes | apt upgrade && pkg install -y bash wget mpv && wget -O - https://raw.githubusercontent.com/The-DiosBot-MD/The-MikuBot-MDV5/master/gata.sh | bash', fkontak)}
