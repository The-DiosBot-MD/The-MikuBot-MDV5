...
> ┃ღ *Usuarios Prohibidos*
> ┃➥ ${Object.entries(global.db.data.users).filter(user => user[1].banned).length} 
> ╰𖠌𖠌𖠌𖠌𖠌𖠌𖠌𖠌𖠌𖠌𖠌𖠌𖠌𖠌𖠌⬣`
await conn.sendButton(m.chat, estado, `𝐓𝐡𝐞-𝐌𝐢𝐤𝐮𝐁𝐨𝐭-𝐌𝐃𝐕5 𝐁𝐲 𝐒𝐮𝐩𝐩𝐨𝐫𝐭\n${asistencia}\n\n` + wm, pp, [
['𝐌𝐞𝐧𝐮 𝐂𝐨𝐦𝐩𝐥𝐞𝐭𝐨', '.allmenu'],
['𝐕𝐞𝐥𝐨𝐜𝐢𝐝𝐚𝐝 𝐝𝐞 𝐞𝐣𝐞𝐜𝐮𝐜𝐢𝐨́𝐧', '/ping'],
['𝐌𝐞𝐧𝐮', '#menu']], null, [
['𝐓𝐡𝐞-𝐌𝐢𝐤𝐮𝐁𝐨𝐭-𝐌𝐃𝐕5', `${md}`]], m)
