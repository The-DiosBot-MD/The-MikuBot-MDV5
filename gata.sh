# Código creado por @GataDios
# Código editado por @AdrianOficial  
...
if wget -q https://github.com/The-DiosBot-MD/The-MikuBot-MDV5/raw/master/musicSH/"$random_mp3"; then
...
echo -e "\033[01;33mpkg install git -y\npkg install nodejs -y\npkg install ffmpeg -y\npkg install imagemagick -y\npkg install -y yarn\ngit clone https://github.com/The-DiosBot-MD/The-MikuBot-MDV5\ncd The-MikuBot-MDV5\nyarn install\nnpm install\nnpm start\033[0m"
exit 1
else
...
echo -e "\033[1;35m"
git clone https://github.com/The-DiosBot-MD/The-MikuBot-MDV5.git
...
echo -e "\033[01;32m\033[01mIniciando The-MikuBot-MDV5!!\n\033[0m"
npm start
